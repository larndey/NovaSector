/obj/item/gun/ballistic/automatic/pulse_rifle/phoenix
	name = "\improper Žaibas phoenix pulse-rifle"
	desc = "A military-grade version of the Žaibas plasma pulse projector."
...
/obj/item/gun/ballistic/automatic/pulse_rifle/phoenix/Initialize(mapload)
	. = ..()
