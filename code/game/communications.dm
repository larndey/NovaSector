...
GLOBAL_LIST_INIT(default_radio_channels, list(
	...
	RADIO_CHANNEL_PHOENIX = FREQ_PHOENIX_COLLECTIVE, //EXONOVA EDIT ADDITION - PHOENIX COLLECTIVE
...
GLOBAL_LIST_INIT(reserved_radio_frequencies, list(
	...
	"[FREQ_PHOENIX_COLLECTIVE]" = RADIO_CHANNEL_PHOENIX, //EXONOVA EDIT ADDITION - PHOENIX COLLECTIVE
